 ...
 */
export const isEurovocTheme = (iri: string) =>
  iri.startsWith(
 ...
 */
export const isFromAccrualPeriodicityCodelist = (iri: string) =>
  iri.startsWith("http://publications.europa.eu/resource/authority/frequency/");
 ...
 */
export const isFromMediaTypeCodelist = (iri: string) =>
  iri.startsWith("http://www.iana.org/assignments/media-types/");

/**
 * @param iri
 * @returns True when given IRI is from European file-type codelist based on the prefix.
 */
export const isFromFormatCodelist = (iri: string) =>
  iri.startsWith("http://publications.europa.eu/resource/authority/file-type/");

/**
 * @param iri
 * @returns True when IRI of applicable legislation indicates high value dataset.
 */
export const isApplicableLegislationHvd = (iri: string) =>
  "http://data.europa.eu/eli/reg_impl/2023/138/oj" === iri;
 ...
 */
export const isTopHvdCategory = (iri: string) =>
  HVD_TOP_CATEGORY[iri] !== undefined;
